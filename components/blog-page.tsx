...
export function BlogPage({ lang }: { lang: Lang }) {
  return (
    <main className="min-h-screen bg-paper text-ink">
      <section className="border-b border-line bg-[linear-gradient(180deg,rgba(212,166,42,0.14),rgba(212,166,42,0.04)_34%,rgba(212,166,42,0)_100%)]">
          ...
          <div className="flex flex-wrap items-start justify-between gap-6">
            ...
            <div className="flex flex-wrap gap-3">
              <Link
                ...
                className="inline-flex min-h-[3.2rem] items-center justify-center border border-line px-5 text-sm font-bold uppercase tracking-[0.18em] text-ink transition duration-200 hover:-translate-y-0.5 hover:bg-[rgba(20,20,20,0.03)]"
              >
      ...
      <section className="page-width mx-auto py-16">
        <div className="grid gap-10">
          {featuredNews.map((post) => (
            <article
              key={post.slug}
              className="grid gap-5 border-t border-line pt-5 md:grid-cols-[minmax(14rem,20rem)_minmax(0,1fr)] md:gap-8"
            >
              <MediaPhoto
                src={post.imageSrc}
              ...
              <div className="max-w-[42rem]">
                <div className="flex flex-wrap gap-x-4 gap-y-2 text-[0.78rem] font-bold uppercase tracking-[0.18em] text-[rgba(20,20,20,0.48)]">
                ...
                <Link
                  ...
                  className="mt-5 inline-flex border-b border-accent pb-1 text-sm font-bold uppercase tracking-[0.18em] text-ink transition duration-200 hover:translate-x-1"
                >
